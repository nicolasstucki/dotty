object Test {
  def main(args: Array[String]): Unit = {
    ...
    checkTrace(foo13(new B), List("foo13", "foo$spec$1", "throws2$spec$2"))
    ...
    checkTrace(foo16(new B), List("foo16", "foo$spec$1", "throws2$spec$2"))
    checkTrace(foo17_1(new B), List("foo17_1", "foo$spec$2", "throws2$spec$3"))
    checkTrace(foo17_2(new A), List("foo17_2", "foo$spec$3", "throws$spec$6"))
    checkTrace(foo18[true](), List("foo18$spec$1", "throws"))
    checkTrace(foo18[false](), List("foo18$spec$1", "throws"))
    checkTrace(foo19[true](true), List("foo19$spec$1", "throws$spec$5"))
    checkTrace(foo19[false](false), List("foo19$spec$1", "throws2$spec$1"))
    val a = new A()
