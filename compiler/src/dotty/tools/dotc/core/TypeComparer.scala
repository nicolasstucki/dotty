    ...
    case tp1: TypeRef =>
      tp1.info match {
        ...
        case _ =>
          ...
          if (tp1.symbol eq NothingClass) tp2.isValueTypeOrLambda && !isPhantomType(tp2)
          else if (tp1.symbol eq NullClass) isNullable(tp2) && !isPhantomType(tp2)
          else if (tp1.symbol eq PhantomNothingClass) tp2.isValueTypeOrLambda && isPhantomType(tp2)
          else false
      }
